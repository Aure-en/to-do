...
class Todo {
  constructor(title, description, date = 'N/A', priority = 'none', project = 'default', section = 'default', id) {
    this.title = title;
